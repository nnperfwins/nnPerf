...
public class ImageClassifierFloat32_SSD_mobileNet_V2_100 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierFloat32_SSD_mobileNet_V2_100(Activity activity) throws IOException {
    super(activity);
  ...
  protected String getModelPath() {
    ...
    return "lite-model_ssd_mobilenet_v2_100_fp32_default_1.tflite";
  }
