...
public class ImageClassifierMobileBert extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierMobileBert(Activity activity) throws IOException {
    super(activity);
  ...
  protected String getModelPath() {
    ...
    return "mobilebert_1_default_1.tflite";
  }
...
//    tflite.run(test, labelProbArray);
    try {
